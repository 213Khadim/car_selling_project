...
@section('title', 'Expenses - AutoDrive Admin')
        ...
        <aside class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <a href="{{ url('/admin/expenses') }}" class="nav-item active">
            ...
            <div class="page-content">
                ...
                <div class="stats-grid">
                    <div class="stat-card">
                        ...
                        <div class="stat-card-content">
                            <div class="stat-card-value">$42,700</div>
                    ...
                    <div class="stat-card">
                        ...
                        <div class="stat-card-content">
                            ...
                            <div class="stat-card-label">Marketing</div>
                        </div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-card-header">
                        ...
                        <div class="stat-card-content">
                            <div class="stat-card-value">$25,000</div>
                            <div class="stat-card-label">Salaries</div>
                        </div>
                    </div>
                    <div class="stat-card">
                        <div class="stat-card-header">
                        ...
                        <div class="stat-card-content">
                            <div class="stat-card-value">$8,000</div>
                            <div class="stat-card-label">Rent</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="data-table-wrapper">
                    <div class="data-table-header">
                        <h3 class="data-table-title">All Expenses</h3>
            ...
            <div class="modal-body">
                <form id="expenseForm">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-input" placeholder="Expense description" required>
                    </div>
                    <div class="form-group">
                        <label class="form-label">Amount ($) *</label>
                        <input type="number" class="form-input" placeholder="1000" required>
                    </div>
                    <div class="form-group">
